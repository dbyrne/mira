...
The complete rig including solar capability totals approximately $14,992 in mandatory components, plus tax and optional quality-of-life additions. The system is built in phases, with each phase delivering standalone capability and the option to pause at any point.
...
| **Total mandatory** | **DSO + Solar combined rig** | **$14,992** |
...
| Phase 2 — Core DSO with Ha | OTA + flattener + camera + EFW + Ha + mini PC + Powerbox + FocusCube + guide + flat panel + accessories | $12,076 |
| Phase 3 — Complete SHO | Add OIII + SII filters | $12,676 |
| Phase 4 — Solar capability (Tier 2) | Quark + UV/IR + ASI174MM + ADC + Sol-Searcher + adapters | $14,989 |
| Phase 5 — Quality of life (optional) | LRGB, battery, rotator, PixInsight, ADC for DSO | +$1,500 |

NJ sales tax (6.625%) adds approximately $993 on the total, bringing the realistic delivered cost to about $15,985 for full DSO + solar capability.
...
## Phase 2 — Core DSO imaging train with Ha (~$8,337 added, cumulative $12,076)
...
## Phase 3 — Complete SHO ($600 added, cumulative $12,676)
...
## Phase 4 — Solar capability, Tier 2 ($2,313 added, cumulative $14,989)
...
7. Mount the ZWO 30F5 guide scope on the OTA's top accessory rail. Install the ASI220MM Mini at the guide scope's focuser end.
8. Mount the mini PC and Powerbox on the OTA accessory rail via the BuckeyeStargazer brackets, positioned side-by-side. Place the mini PC forward (above the front tube ring area) and the Powerbox aft (above the rear ring/focuser area) to optimize fore/aft balance and minimize heat plume contamination of the camera cooling environment.
...
1. Mount the mini PC to the OTA accessory rail or saddle plate using a Vixen-style PC bracket. Connect to mount via USB, main camera via USB 3, EFW via USB 2, Pegasus Powerbox via USB 2, guide camera via USB 2, FocusCube via USB 2.
