...
- VSX type: `LB:`
- Coordinates: RA `173.21846`, Dec `79.91661`
- Catalog photometry: bright `8.173` V; amplitude `0.123` mag w
- Catalog amplitude: `0.123` mag
- Period: `43.52760000` days
- Spectral type: `M1`
...
- Max altitude in dark window: `57.8 deg`
...
- max altitude 57.8 deg from Fairbanks
...
- bright enough for Fairbanks (8.17)
- long-period cadence friendly (43.53 d)
...
- Note: 405 Client Error: Not Allowed for url: https://vsx.aavso.org/index.php?view=api.object&ident=FP+Cam&data=50000&fromjd=2460435.08673&tojd=2461165.08673&csv=&band=V%2CVis.%2CCV%2CTG%2CB%2CR%2CI&mtype=std
...
- Status: `ok`
- Source ID: `1130186391579584256`
- G magnitude: `7.204`
- BP-RP color: `2.352`
- Parallax: `0.947` +/- `0.015` mas
- RUWE: `0.987`
- Gaia photometric variability flag: `not flagged`
- Match separation: `0.081` arcsec
