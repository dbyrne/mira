...
# M13 core + an outer-halo sample point (J2000) — for locating regions via WCS.
# (var names kept as M51_*/N5195_* so the stats block downstream is unchanged;
#  values point at M13: core SNR + a ~8' N halo sample standing in for "bridge".)
M51_RA, M51_DEC = 250.4217, 36.4603
N5195_RA, N5195_DEC = 250.4217, 36.6000
