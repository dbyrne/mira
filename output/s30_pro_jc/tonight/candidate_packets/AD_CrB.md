...
- VSX type: `SRB:`
- Coordinates: RA `241.78609`, Dec `32.37958`
- Catalog photometry: range `8.730-9.110` (Hp/Hp)
- Catalog amplitude: `0.380` mag
- Period: `` days
- Spectral type: `M8`
- Galactic latitude: `47.6 deg`
...
- modest catalog amplitude about 0.38 mag
...
- Main ID: `V* AD CrB`
- Object type: `LP*`
- Match separation: `0.044` arcsec
- Search: https://simbad.cds.unistra.fr/simbad/sim-coo?Coord=241.786090+32.379580&Radius=5.0&Radius.unit=arcsec
- Other IDs: `TIC 17408089`, `HIP 78959`, `Gaia DR3 1322354154800172160`, `AG+32 1386`, `BD+32  2679`, `GSC 02573-00801`, `HIC  78959`, `IRAS 16052+3230`

## Gaia DR3 Context

- Status: `ok`
- Source ID: `1322354154800172160`
- G magnitude: `7.226`
- BP-RP color: `3.591`
- Parallax: `2.046` +/- `0.028` mas
- RUWE: `1.038`
