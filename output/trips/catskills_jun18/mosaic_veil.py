...
Run:  python output/catskills_jun18/mosaic_veil.py
...
P1 = "output/catskills_jun18/veil_p1_west_stack.fit"
P2 = "output/catskills_jun18/veil_p2_east_stack.fit"
OUT = "output/catskills_jun18/veil_mosaic.fit"
